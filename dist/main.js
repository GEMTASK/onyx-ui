...
function Xe(e) {
	let t = (0, j.c)(21), n, r, i, a, o;
	t[0] === e ? (n = t[1], r = t[2], i = t[3], a = t[4], o = t[5]) : ({light: a, icon: i, fillColor: r, children: n, ...o} = e, t[0] = e, t[1] = n, t[2] = r, t[3] = i, t[4] = a, t[5] = o);
	let s;
	t[6] !== i || t[7] !== a ? (s = i && /* @__PURE__ */ (0, M.jsx)(Oe, {
		icon: i,
		size: 14,
		style: {
			margin: "-2px 0",
	...
	}), t[6] = i, t[7] = a, t[8] = s) : s = t[8];
	let c = r ? "2px 4px" : void 0, l = r ? "-2px 0" : void 0, u;
	t[9] === l ? u = t[10] : (u = {
		margin: l,
		boxShadow: "0 0 0 1px var(--content-color)"
	}, t[9] = l, t[10] = u);
	let d;
	t[11] !== n || t[12] !== r || t[13] !== a || t[14] !== o || t[15] !== c || t[16] !== u ? (d = /* @__PURE__ */ (0, M.jsx)(B, {
		light: a,
		fillColor: r,
		cornerRadius: "2px",
		...o,
		...
		style: u,
		children: n
	}), t[11] = n, t[12] = r, t[13] = a, t[14] = o, t[15] = c, t[16] = u, t[17] = d) : d = t[17];
	let f;
	return t[18] !== s || t[19] !== d ? (f = /* @__PURE__ */ (0, M.jsxs)(z, {
		horizontal: !0,
		spacing: "4px",
		align: "middle left",
		children: [s, d]
	}), t[18] = s, t[19] = d, t[20] = f) : f = t[20], f;
}
//#endregion
...
var ut = /* @__PURE__ */ x({
	...
	spaceSeparated: () => G
}), dt = 0, H = mt(), U = mt(), ft = mt(), W = mt(), G = mt(), pt = mt(), K = mt();
function mt() {
	return 2 ** ++dt;
}
//#endregion
//#region node_modules/property-information/lib/util/defined-info.js
var ht = Object.keys(ut), gt = class extends V {
	constructor(e, t, n, r) {
		let i = -1;
		if (super(e, t), _t(this, "space", r), typeof n == "number") for (; ++i < ht.length;) {
			let e = ht[i];
			_t(this, ht[i], (n & ut[e]) === ut[e]);
		}
	}
};
...
function vn(e, t, n) {
	...
	if (!(n == null || typeof n == "number" && Number.isNaN(n))) {
		if (Array.isArray(n) && (n = r.commaSeparated ? $e(n) : It(n)), r.property === "style") {
...
var Vn = Yn(/[A-Za-z]/), J = Yn(/[\dA-Za-z]/), Hn = Yn(/[#-'*+\--9=?A-Z^-~]/);
function Un(e) {
...
function or(e, t) {
	...
	for (; ++n < e.length;) if (e[n][0] === "enter" && e[n][1].type === "attentionSequence" && e[n][1]._close) {
		for (r = n; r--;) if (e[r][0] === "exit" && e[r][1].type === "attentionSequence" && e[r][1]._open && t.sliceSerialize(e[r][1]).charCodeAt(0) === t.sliceSerialize(e[n][1]).charCodeAt(0)) {
			...
			]), l = Pn(l, ir(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t)), l = Pn(l, [
				[
					"exit",
					a,
					t
...
function br(e, t, n) {
	...
	function u(s) {
		if (s === 59 && i) {
			...
			return o === J && !Mn(r.sliceSerialize(i)) ? n(s) : (e.enter("characterReferenceMarker"), e.consume(s), e.exit("characterReferenceMarker"), e.exit("characterReference"), t);
		}
...
function si(e, t, n) {
	...
	function O(t) {
		return t === 45 && i === 2 ? (e.consume(t), M) : t === 60 && i === 1 ? (e.consume(t), N) : t === 62 && i === 4 ? (e.consume(t), L) : t === 63 && i === 3 ? (e.consume(t), I) : t === 93 && i === 5 ? (e.consume(t), F) : Y(t) && (i === 6 || i === 7) ? (e.exit("htmlFlowData"), e.check(ii, R, k)(t)) : t === null || Y(t) ? (e.exit("htmlFlowData"), k(t)) : (e.consume(t), O);
	}
	function k(t) {
		return e.check(ai, A, R)(t);
	}
	function A(t) {
	...
	function P(t) {
		if (t === 62) {
			let n = o.toLowerCase();
			return ni.includes(n) ? (e.consume(t), L) : O(t);
		}
...
function _i(e, t) {
	...
	return s = [[
		...
		u,
		t
	]]), s = Pn(s, ir(t.parser.constructs.insideSpan.null, e.slice(a + r + 4, o - 3), t)), s = Pn(s, [
		[
			"exit",
			u,
			t
...
function ia(e, t, n) {
	...
	function d(e) {
		return o = Pn(o, e), g(), o[o.length - 1] === null ? (w(t, 0), l.events = ir(a, l.events, l), l.events) : [];
	}
	function f(e, t) {
		return oa(p(e), t);
	}
...
function ga(e) {
	...
	function P(e) {
		...
		n.label = fa(t), n.identifier = Bn(t).toLowerCase();
	}
	function F() {
...
//#endregion
export { Ye as Avatar, Ee as Button, Be as Checkbox, Xe as Chip, Ae as Divider, Ke as Form, N as Hello, Oe as Icon, qe as Label, je as List, js as Markdown, Re as Menu, Pe as Popover, He as Select, Qe as Tabs, B as Text, z as View };
