...
declare function View<TDelegate extends React.ElementType = "div">({ as, flex, wrap, horizontal, absolute, sticky, opacityOnPress, zIndex, shadow, cursor, padding, spacing, border, negativeBorder, align, fillColor, borderColor, cornerRadius, tooltip, tooltipAnchor, style, className, children, ...props }: Delegate<{
    as?: TDelegate;
    flex?: boolean;
    wrap?: boolean;
    horizontal?: boolean;
