...
declare function Text<TDelegate extends React.ElementType = "div">({ as, light, caps, bold, select, ellipsis, noWrap, fontSize, fontWeight, textColor, innerStyle, children, ...props }: {
    as?: TDelegate;
    light?: boolean;
    caps?: boolean;
    bold?: boolean;
