...
declare const Input: ({ label, value: _value, lines, border, flush, multiline, icon, inputRef, placeholder, autoFocus, changeOnEnter, innerStyle, onValueChange, ...props }: Delegate<{
