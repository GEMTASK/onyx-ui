...
declare function Chip({ ref, icon, fontSize, iconSize, iconColor, iconLight, fillColor, outlineColor, tooltip, opacityOnPress, children, style, onPointerDown, onClick, ...props }: Delegate<{
