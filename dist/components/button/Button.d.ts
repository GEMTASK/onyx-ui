...
declare function Button({ ref, type, solid, primary, hover, active, icon, iconColor, iconFill, iconSize, rightIcon, round, bold, fontWeight, selected, opacityOnPress, className, children, ...props }: Delegate<{
